...
_function_showMenu = 
{
	...
	(_dialog displayCtrl 120) ctrlEnable true;
	...
	(_dialog displayCtrl 120) ctrlSetFade 1;
	...
	(_dialog displayCtrl 120) ctrlCommit 0;
	...
	(_dialog displayCtrl 120) ctrlSetFade 0;
	...
	(_dialog displayCtrl 120) ctrlCommit 1;
	...
	(_dialog displayCtrl 120) ctrlSetPosition [0.55,0.64];
	...
	(_dialog displayCtrl 120) ctrlCommit 0.8;
...
//	(_dialog displayCtrl 8003) ctrlSetPosition [0.408,0.78];
	...
	(_dialog displayCtrl 120) ctrlCommit 0.3;
...
_function_hideMenu = 
{
	...
	(_dialog displayCtrl 120) ctrlEnable false;
	...
	(_dialog displayCtrl 120) ctrlCommit _hide_delay;
...
// schování mimo obrazovku
	...
	(_dialog displayCtrl 120) ctrlSetPosition [2.55,2.825];
