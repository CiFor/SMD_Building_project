...
(_dialog displayCtrl 8002) ctrlSetPosition [0.55546,0.644];
(_dialog displayCtrl 8003) ctrlSetPosition [0.545,0.78];

(_dialog displayCtrl 105) ctrlSetPosition [0.55,0.64];
(_dialog displayCtrl 8201) ctrlSetPosition [0.55,0.64];
(_dialog displayCtrl 8202) ctrlSetPosition [0.55546,0.644];
...
(_dialog displayCtrl 8302) ctrlSetPosition [0.55546,0.644];
...
(_dialog displayCtrl 8002) ctrlSetPosition [-0.55546,-0.829];
(_dialog displayCtrl 8003) ctrlSetPosition [-0.545,-0.9];

(_dialog displayCtrl 120) ctrlSetPosition [-0.55,-0.825];
(_dialog displayCtrl 8101) ctrlSetPosition [-0.55,-0.825];
(_dialog displayCtrl 8102) ctrlSetPosition [-0.55546,-0.829];
(_dialog displayCtrl 8103) ctrlSetPosition [-0.545,-0.9];

(_dialog displayCtrl 105) ctrlSetPosition [-0.55,-0.825];
(_dialog displayCtrl 8201) ctrlSetPosition [-0.55,-0.825];
(_dialog displayCtrl 8202) ctrlSetPosition [-0.55546,-0.829];
(_dialog displayCtrl 8203) ctrlSetPosition [-0.545,-0.9];

(_dialog displayCtrl 115) ctrlSetPosition [-0.55,-0.825];
(_dialog displayCtrl 8301) ctrlSetPosition [-0.55,-0.825];
(_dialog displayCtrl 8302) ctrlSetPosition [-0.55546,-0.829];
(_dialog displayCtrl 8303) ctrlSetPosition [-0.545,-0.9];
...
(_dialog displayCtrl 120) ctrlCommit 0.1;
