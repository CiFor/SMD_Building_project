...
CA_MM_active_controls = ["Control #1130","Control #1110","Control #104","Control #105","Control #106","Control #109","Control #115","Control #117","Control #120","Control #301","Control #302","Control #303","Control #304"];
...
_MENU_campaign_array = [120,1021,1022,1023,1024];
...
_playButtonsDelta = (abs(((ctrlPosition (_dialog displayCtrl 117)) select 1) - ((ctrlPosition (_dialog displayCtrl 120)) select 1)));
