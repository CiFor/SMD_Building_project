...
switch _action do 
{
	...
	case "MouseButtonUp": 
	{
		if (( _actionKeyCode == 0 || _actionKeyCode == 57 || _actionKeyCode == 28 || _actionKeyCode == 156) && (MM_buttonDown) ) then {
	...
	{
		if (( _actionKeyCode == 0 || _actionKeyCode == 57 || _actionKeyCode == 28 || _actionKeyCode == 156) && (!MM_buttonDown) && (ctrlCommitted _control)) then {
			[_button_elements_array, false, 0, [0.002,0.002]] call processIDCs;
			MM_buttonDown = true;
		};
	};
